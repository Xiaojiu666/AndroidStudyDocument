...
- 创建一个实体类，并且在类上加上注释@Entity
      ...
      String title;               //日记标题
      String diaryContant;        //日记内容
      String diaryBgImage;        //日记背景图片
      int   diarySize;            //日记长度
      String weather;             //天气
      String location;            //发布地点
      int isLock;                 //是否加密  0:true 1:false
      String password;            //密码
      int diaryType;              //日记类型
      @Generated(hash = 1312642170)
      public DiaryInfo(Long id, String creatDate, String modifyDate, String title,
           String diaryContant, String diaryBgImage, int diarySize, String weather,
           String location, int isLock, String password, int diaryType) {
         this.id = id;
         this.creatDate = creatDate;
         this.modifyDate = modifyDate;
         this.title = title;
         this.diaryContant = diaryContant;
         this.diaryBgImage = diaryBgImage;
